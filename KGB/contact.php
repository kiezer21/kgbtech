...
<body>
    <div class="alert alert-primary" role="alert">
        <h1 class="text-center mt-2 mb-2">Store Rating/Review System</h1>
    </div>
    <div class="container">
    		...
    		<div class="card-body">
    			<div class="row">
                    <div class="col-sm-3 text-center">
    					<button type="button" name="add_review" id="add_review" class="btn btn-primary form-control mt-3">Rate/Review Our Store</button>
    				</div>
        ...
        <h3 class="mt-3 ml-4">Store Reviews:</h3>
