               ...
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           Delivered within 1-2 days depending on your location
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           No shipping fee within the Philippines only
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                           Discover unparalleled quality with our products. 
                        </p>
                     </div>
                  </div>
               </div>
...
.image-box {
    text-align: center;
    height: 300px; /* Set a fixed height for all image boxes */
}
...
.image-box p {
    ...
    font-family: Arial, sans-serif; color: #f7444e;  ">K G B  TEAM</h1>
         <br>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="image-box">
                    <img src="images/gelo.jpg" alt="Image 1">
                    <p>Mr. Rafael Angelo Chio Sr.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="image-box">
                    <img src="images/kiez.jpg" alt="Image 2">
                    <p>Mr. Kiezer Mala</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="image-box">
                    <img src="images/nix.png" alt="Image 3">
                    <p>Mr. Bennix Usman Jr.</p>
                </div>
            </div>
        </div>
    </div>
